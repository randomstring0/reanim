...
local accessorylimbs = {
    { meshid = "3030546036", textureid = "3443321249", C0 = angles(-1.6144, -pi / 2, 0) * cf(0.125, 0.3, 0), Name = "Right Arm" },
    { meshid = "14255522247", textureid = "", C0 = angles(-pi / 2, 0, pi / 2), Name = "Right Leg" },
    { meshid = "99608462237958", textureid = "", C0 = angles(0, 0, pi / 2), Name = "Right Leg" },
    { meshid = "3030546036", textureid = "3360974849", C0 = angles(1.5272, pi / 2, 0) * cf(-0.125, -0.35, 0), Name = "Left Leg" },
    { meshid = "4819720316", textureid = "4819722776", C0 = angles(0, 0, 0.2618), Name = "Torso" },
    { meshid = "12652772399", textureid = "12652775021", C0 = cf(0, -0.125, 0), Name = "Right Leg" },
    { meshid = "14768684979", textureid = "", C0 = angles(0, 0, pi / 2), Name = "Left Arm" },
    { meshid = "4324138105", textureid = "4324138210", C0 = angles(-1.6144, pi / 2, 0) * cf(-0.125, 0.3, 0), Name = "Left Arm" },
    { meshid = "4154474745", textureid = "4154474807", C0 = angles(1.5272, -pi / 2, 0) * cf(-0.125, -0.3, 0), Name = "Left Arm" },
    { meshid = "14241018198", textureid = "", C0 = cf_0, Name = "Torso" },
    { meshid = "4324138105", textureid = "4391374782", C0 = angles(0, 0, pi / 2), Name = "Right Arm" },
    { meshid = "17387586286", textureid = "", C0 = angles(-pi / 2, 0, pi / 2), Name = "Right Leg" },
    { meshid = "17387586286", textureid = "", C0 = angles(pi / 2, 0, pi / 2), Name = "Left Leg" },
    { meshid = "3030546036", textureid = "3033898741", C0 = angles(1.5272, -pi / 2, 0) * cf(0.125, -0.35, 0), Name = "Right Leg" },
    { meshid = "13831073174", textureid = "", C0 = cfMul(cf(0.017, 0, -0.23), angles(-1.4835, -0.1571, 2.1991)), Name = "Left Arm" },
    { meshid = "13421774668", textureid = "", C0 = cf_0, Name = "Torso" },
    { meshid = "14768684979", textureid = "", C0 = angles(0, 0, pi / 2), Name = "Right Arm" },
    { meshid = "17374767929", textureid = "", C0 = angles(-pi / 2, 0, pi / 2), Name = "Right Arm" },
    { meshid = "13839903766", textureid = "", C0 = cfMul(cf(0, -0.62, -0.01), angles(1.6581, 0.1571, -2.1991)), Name = "Right Arm" },
    { meshid = "3030546036", textureid = "3650191503", C0 = angles(1.5272, pi / 2, 0) * cf(0.125, -0.3, 0), Name = "Right Arm" },
    { meshid = "90736849096372", textureid = "", C0 = angles(0, 0, pi / 2), Name = "Left Arm" },
    { meshid = "4489232754", textureid = "4489233876", C0 = angles(0, 0, pi / 2), Name = "Left Arm" },
    { meshid = "17374767929", textureid = "", C0 = angles(pi / 2, 0, pi / 2), Name = "Left Arm" },
    { meshid = "12344206657", textureid = "", C0 = angles(2, 0, 0), Name = "Right Arm" },
    { meshid = "12344207333", textureid = "", C0 = angles(2, 0, 0), Name = "Left Arm" },
    { meshid = "14255522247", textureid = "", C0 = angles(pi / 2, 0, pi / 2), Name = "Left Leg" },
    { meshid = "127552124837034", textureid = "131014325980101", C0 = cf_0, Name = "Torso" },
    { meshid = "121304376791439", textureid = "131014325980101", C0 = cf_0, Name = "Right Arm" },
    { meshid = "117287001096396", textureid = "120169691545791", C0 = cf_0, Name = "Left Arm" },
    { meshid = "121304376791439", textureid = "131014325980101", C0 = cf_0, Name = "Right Leg" },
    { meshid = "117287001096396", textureid = "120169691545791", C0 = cf_0, Name = "Left Leg" },
    { meshid = "125405780718494", textureid = "136752500636691", C0 = angles(0, 0, pi / 2), Name = "Right Leg" },
    { meshid = "125405780718494", textureid = "136752500636691", C0 = angles(0, 0, pi / 2), Name = "Left Leg" },
    { meshid = "126825022897778", textureid = "", C0 = cf_0, Name = "Torso" },
    { meshid = "", textureid = "73798034827573", C0 = angles(0, 0, pi / 2), Name = "Left Leg" },
    { meshid = "", textureid = "73798034827573", C0 = angles(0, 0, pi / 2), Name = "Right Leg" },
    { meshid = "", textureid = "135650240593878", C0 = angles(0, 0, pi / 2), Name = "Left Arm" },
    { meshid = "", textureid = "135650240593878", C0 = angles(0, 0, pi / 2), Name = "Right Arm" },
    { meshid = "11263221350", textureid = "11263219250", C0 = angles(pi / 2, -pi / 2, 0), Name = "Right Leg" },
    { meshid = "11159370334", textureid = "11159284657", C0 = angles(pi / 2, pi / 2, 0), Name = "Left Leg" },
    { meshid = "139733645770094", textureid="", C0=angles(0,0,pi / 2), Name = "Left Leg" },
    { meshid = "105141400603933", textureid="", C0=angles(0,0,pi / 2), Name = "Right Arm" },
    { meshid = "110684113028749", textureid = "", C0 = cf_0, Name="Torso" },
    { meshid = "3030546036", textureid = "3360978739", C0 = cfMul(angles(-1.6144295580947547,-pi / 2,0), cf(-0.125,0.3,0)),Name = "Left Leg" },
    { meshid = "3030546036", textureid = "3409604993", C0 = cfMul(angles(-1.6144295580947547,pi / 2,0), cf(0.125,0.3,0)),Name = "Right Leg" },
...
local placeholders=config.placeholders or false
local clickfling=config.clickfling or false
local highlightflingtargets=config.highlightflingtargets or false
local discharscripts=config.discharscripts or false
local flingchangestate=config.flingchangestate or 1
local respawntp=config.respawntp or 1
